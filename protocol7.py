...
while True:
    ...
    for currentItem in urlList:
        ...
        dashboardText2 = dashboardText2 + '<div class="columns" title="' + urlList[currentItem]["url"] + '" onclick="window.open(\'' + dashboardBaseURL + '/' + str(urlList[currentItem]) + '.html' + '\', \'_blank\');"><div class="' + currentHeader + '"><p><b class="app_name">' + str(urlList[currentItem]['appname']) + '</b><br/><font class="customer_name">' + urlList[currentItem]["customer"] + '</font></p><p><b>Failtage</b>: ' + str(currentFailtage) + '%<br/><b>Resp. time</b>: ' + str(currentRespTime) + ' seconds<br/><b>Status</b>: ' + currentStatus + '<br/><b>Deployments</b>: ' + urlList[currentItem]["latest_deployment"] + '</p></div></div>'
